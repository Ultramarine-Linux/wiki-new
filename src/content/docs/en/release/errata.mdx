...
### Base Image (No Desktop)

- Initial setup doesn't drop to a TTY

  You have to manually switch to a TTY after creating a user, any of them work.

- Rebooting just launches initial setup again

  Just click finish or switch to another TTY.
